...
<Container class="relative" role="main">
  ...
  <Title class="my-16"
    ...
    <strong
      class="from-gradient-start to-gradient-end bg-gradient-to-r bg-clip-text font-black text-transparent"
      >professional website</strong
    ></Title
  >
  <Text class="my-16 text-balance"
    >I build websites that help small businesses look professional and get more customers online.</Text
  >
  <Browser />
</Container>

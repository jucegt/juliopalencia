...
>
  ...
  >
    ...
    ></div>
    <div
      class="bg-skyblue absolute right-[70%] bottom-[40px] aspect-square w-[100px] rounded-full blur-[80px] sm:w-[180px] sm:blur-[110px] lg:w-xs lg:blur-[200px] dark:blur-[120px] sm:dark:blur-[165px] lg:dark:blur-[300px]"
    ></div>
  </div>
</div>

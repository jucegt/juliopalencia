...
<div class={cn(restProps.class)}>
  ...
  <div class="relative">
    <input
      ...
      class={cn(
        'peer bg-light-50 ring-offset-light-200 border-light-200 text-dark dark:text-light focus:ring-primary dark:bg-dark-50 dark:border-dark-200 dark:ring-offset-dark-100 dark:placeholder:text-dark-placeholder h-12 w-full rounded-lg border placeholder:text-gray-200 focus:ring-2 focus:ring-offset-2',
        icon && 'pl-12',
